...
INSERT INTO tb_intership_offer (principalActivity, weeklyWorkload, remunerationValue, transportVoucher, prerequisites, companyResponsible, status) VALUES
    ...
    ('Pesquisa de Mercado', 25, 1400.00, 100.00, 'Habilidades analíticas e conhecimento em pesquisa', 15, 'FINALIZADA'),
    ('Desenvolvimento Mobile', 30, 1700.00, 200.00, 'Experiência com Android e iOS', 16, 'ABERTA'),
    ('Redação Publicitária', 15, 1250.00, 120.00, 'Experiência com copywriting e campanhas publicitárias', 17, 'ABERTA'),
    ...
    ('Administração de Banco de Dados', 25, 1600.00, 0.00, 'Experiência com SQL e administração de DB', 3, 'FINALIZADA'),
    ('Design de Interação', 20, 1400.00, 150.00, 'Conhecimento em UX/UI', 4, 'ABERTA'),
    ('Marketing de Conteúdo', 25, 1500.00, 160.00, 'Experiência com criação de conteúdo e estratégias de marketing', 5, 'CANCELADA'),
    ('Segurança da Informação', 30, 2000.00, 250.00, 'Certificação em segurança da informação', 6, 'ABERTA'),
    ('Automação de Processos', 20, 1700.00, 220.00, 'Experiência com ferramentas de automação', 7, 'FINALIZADA'),
    ('Gestão de TI', 30, 1800.00, 200.00, 'Experiência em gerenciamento de equipes de TI', 8, 'ABERTA'),
    ('Controle de Qualidade', 25, 1500.00, 180.00, 'Conhecimento em técnicas de controle de qualidade', 9, 'CANCELADA'),
    ('Engenharia de Dados', 20, 1900.00, 220.00, 'Experiência com big data e ferramentas de engenharia', 10, 'ABERTA'),
    ('Planejamento Estratégico', 25, 1600.00, 150.00, 'Formação em administração e experiência em planejamento', 11, 'FINALIZADA'),
    ('Produção de Vídeo', 20, 1400.00, 100.00, 'Experiência com edição e produção de vídeos', 12, 'ABERTA'),
    ('Administração de Projetos', 25, 1550.00, 200.00, 'Certificação PMP ou equivalente', 13, 'CANCELADA'),
    ('Desenvolvimento Frontend', 20, 1700.00, 180.00, 'Experiência com React e Angular', 14, 'ABERTA'),
    ('Engenharia de Redes', 30, 1800.00, 200.00, 'Certificação em redes e conhecimento em protocolos', 15, 'FINALIZADA'),
    ('Planejamento de Mídia', 20, 1450.00, 120.00, 'Experiência com planejamento de campanhas publicitárias', 16, 'ABERTA'),
    ('Desenvolvimento de Sistemas', 25, 1750.00, 220.00, 'Conhecimento em desenvolvimento de sistemas', 17, 'CANCELADA'),
    ('Consultoria de Recursos Humanos', 30, 1500.00, 180.00, 'Experiência com gestão de talentos', 18, 'ABERTA'),
    ('Logística', 20, 1300.00, 0.00, 'Experiência em gestão de cadeias de suprimentos', 19, 'FINALIZADA'),
    ('Planejamento de Eventos', 25, 1600.00, 150.00, 'Experiência em organização e planejamento de eventos', 20, 'CANCELADA');
