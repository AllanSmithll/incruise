...
VALUES ('Coordenador_Sistemas', 'coordenador.sistemas@gmail.com', 'Coordenador123', TRUE, 2),
       ('Tech_Innovators', 'Tech_Innovators@gmail.com', 'password123', TRUE, 4),
       ('NextGen_Solutions', 'NextGen_Solutions@gmail.com', 'password123', TRUE, 4),
       ('CloudWare_gmail', 'CloudWare_gmail@gmail.com', 'password123', TRUE, 4),
       ('DataStream_Labs', 'DataStream_Labs@gmail.com', 'password123', TRUE, 4),
       ('SoftTech_Corp', 'SoftTech_Corp@gmail.com', 'password123', TRUE, 4),
       ('CyberSec_Brasil', 'CyberSec_Brasil@gmail.com', 'password123', TRUE, 4),
       ('AI_Innovations', 'AI_Innovations@gmail.com', 'password123', TRUE, 4),
       ('Quantum_Solutions', 'Quantum_Solutions@gmail.com', 'password123', TRUE, 4),
       ('DevOps_Masters', 'DevOps_Masters@gmail.com', 'password123', TRUE, 4),
       ('ByteLab_gmail', 'ByteLab_gmail@gmail.com', 'password123', TRUE, 4),
       ('SmartGrid_Tech', 'SmartGrid_Tech@gmail.com', 'password123', TRUE, 4),
       ('VR_World', 'VR_World@gmail.com', 'password123', TRUE, 4),
       ('Blockchain_Solutions', 'Blockchain_Solutions@gmail.com', 'password123', TRUE, 4),
       ('RoboTech_gmail', 'RoboTech_gmail@gmail.com', 'password123', TRUE, 4),
       ('Innovatech_gmail', 'Innovatech_gmail@gmail.com', 'password123', TRUE, 4),
       ('WebDev_Solutions', 'WebDev_Solutions@gmail.com', 'password123', TRUE, 4),
       ('AI_Robotics', 'AI_Robotics@gmail.com', 'password123', TRUE, 4),
       ('GreenTech_gmail', 'GreenTech_gmail@gmail.com', 'password123', TRUE, 4),
       ('Infinity_Networks', 'Infinity_Networks@gmail.com', 'password123', TRUE, 4),
       ('CodeCraft_gmail', 'CodeCraft_gmail@gmail.com', 'password123', TRUE, 4),
       ('Yuri_Souza', 'Yuri.Souza@gmail.com', 'Yuri123', TRUE, 3),
       ('Haniel_Silva', 'Haniel.Silva@gmail.com', 'Haniel123', TRUE, 3),
       ('Marcio_Silva', 'Marcio.Silva@gmail.com', 'Marcio123', TRUE, 3),
       ('Allan_Amancio', 'Allan.Amancio@gmail.com', 'Allan123', TRUE, 3),
       ('Matheus_Sousa', 'Matheus.Sousa@gmail.com', 'Matheus123', TRUE, 3),
       ('Brian_Trajano', 'Brian.Trajano@gmail.com', 'Brian123', TRUE, 3),
       ('Ian_Mendonca', 'Ian.Mendonca@gmail.com', 'Ian123', TRUE, 3),
       ('George_Lima', 'George.Lima@gmail.com', 'George123', TRUE, 3),
       ('Marcela_Kramer', 'Marcela.Kramer@gmail.com', 'Marcela123', TRUE, 3),
       ('Renato_Melo', 'Renato.Melo@gmail.com', 'Renato123', TRUE, 3),
       ('Yago_Aguiar', 'Yago.Aguiar@gmail.com', 'Yago123', TRUE, 3),
       ('Amanda_Araujo', 'Amanda.Araujo@gmail.com', 'Amanda123', TRUE, 3),
       ('Olivia_Oliva', 'Olivia.Oliva@gmail.com', 'Olivia123', TRUE, 3),
       ('Raqueline_Gomes', 'Raqueline.Gomes@gmail.com', 'Raqueline123', TRUE, 3),
       ('Geraldo_Neto', 'Geraldo.Neto@gmail.com', 'Geraldo123', TRUE, 3),
       ('Juliana_Cavalcante', 'Juliana.Cavalcante@gmail.com', 'Juliana123', TRUE, 3),
       ('Pedro_Bravim', 'Pedro.Bravim@gmail.com', 'Pedro123', TRUE, 3),
       ('Juan_Farias', 'Juan.Farias@gmail.com', 'Juan123', TRUE, 3),
       ('Joao_Dias', 'Joao.Dias@gmail.com', 'Joao123', TRUE, 3),
       ('Alic_Andrade', 'Alic.Andrade@gmail.com', 'Alic123', TRUE, 3),
       ('Luis_Kilmer', 'Luis.Kilmer@gmail.com', 'Luis123', TRUE, 3);
 ...
 */
INSERT INTO tb_internship_offer (id, principal_activity, weekly_workload, remuneration_value, transport_voucher,
                                 prerequisites, company_id, status)
VALUES (1, 'Desenvolvimento de Software', 20, 1500.00, 200.00, 'Conhecimento em Java e SQL', 1, 'ABERTA'),
       ...
       (15, 'Pesquisa de Mercado', 25, 1400.00, 100.00, 'Habilidades analíticas e conhecimento em pesquisa', 15,
        'FINALIZADA'),
       (16, 'Desenvolvimento Mobile', 30, 1700.00, 200.00, 'Experiência com Android e iOS', 16, 'ABERTA'),
       (17, 'Redação Publicitária', 15, 1250.00, 120.00, 'Experiência com copywriting e campanhas publicitárias', 17,
        'ABERTA'),
       ...
       (23, 'Administração de Banco de Dados', 25, 1600.00, 0.00, 'Experiência com SQL e administração de DB', 3,
        'FINALIZADA'),
       (24, 'Design de Interação', 20, 1400.00, 150.00, 'Conhecimento em UX/UI', 4, 'ABERTA'),
       (25, 'Marketing de Conteúdo', 25, 1500.00, 160.00,
       ...
       (29, 'Controle de Qualidade', 25, 1500.00, 180.00, 'Conhecimento em técnicas de controle de qualidade', 9,
        'CANCELADA'),
       (30, 'Engenharia de Dados', 20, 1900.00, 220.00, 'Experiência com big data e ferramentas de engenharia', 10,
        'ABERTA');
