...
public class InternshipOffer extends Opportunity {
	...
	public InternshipOffer(Integer id, String principalActivity, Integer weeklyWorkload, Double remunerationValue, Double transportVoucher, String prerequisites, Company company) {
